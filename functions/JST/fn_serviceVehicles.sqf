...
if (!isNil "opf_veh_pad1") then
{
	[JST_opfPadNearVehs, opf_veh_pad1] spawn JST_fnc_serviceVehicles;
};
if (!isNil "opf_veh_pad2") then
{
	[JST_opfPadNearVehs, opf_veh_pad2] spawn JST_fnc_serviceVehicles;
};